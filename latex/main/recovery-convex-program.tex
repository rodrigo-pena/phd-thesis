...
\begin{proof}
    ...
    \step{}{
        ...
        \begin{proof}
            ...
            \step{}{$\mathbf{u} \in \mathcal{D}(f, \mathbf{x}) \iff \mathbf{u} = \mathbf{0}$}~\qedsymbol
        \end{proof}
